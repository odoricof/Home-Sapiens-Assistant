...
- domo/sensor.py : DomoMeter class, get_all_meters()
...
class DomoMeter:
    ...
    def unique_id_power(self) -> str:
        """Unique ID for the instant power sensor."""
        return f"sensor.domo_{self._meter_id}_power"

    @property
    def unique_id_energy(self) -> str:
        """Unique ID for the energy sensor (consumption/production)."""
    ...
    def last_24h_avg(self) -> float:
        """Consumption/production over the last 24 hours."""
        return self._last_24h_avg

    @property
    def last_month_avg(self) -> float:
        """Consumption/production over the last month."""
        return self._last_month_avg

    @property
    def is_production(self) -> bool:
        """True if this is a production meter, False if consumption."""
    ...
    def update_state(self, data: dict[str, Any]) -> bool:
        """Update the meter state with new data."""
...
async def discover_meters(gateway):
    """Discover all available energy meters."""
