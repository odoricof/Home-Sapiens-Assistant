...
class SecurityEventsLogger:
    def __init__(self, hass):
        ...
        self._last_logged_state = None  # Inizializzato qui!
    ...
    def _handle_update(self):
        ...
        current_state_key = f"{date} {time}:{data_hash}"
        
        if self._last_logged_state != current_state_key:
            _event_logger.info(log_line)
            self._last_logged_state = current_state_key
